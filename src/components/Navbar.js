    ...
    return (
      <nav className="navbar is-transparent">
        <div className="navbar-brand">
          <a className="navbar-item is-size-4 has-text-weight-semibold has-text-white" href="/">
            ...
            <div className="navbar-item">
              <div className="field is-grouped is-size-5 has-text-white">
                <a
                  ...
                  data-target="modal"
                  aria-haspopup="true"
                  onClick={this.toggleAddress}>Address</a>
                <a
                  className="navbar-item"
                  data-target="modal"
                  aria-haspopup="true"
                  onClick={this.toggleContact}>Contact</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="modal-card">
            <header className="modal-card-head">
              ...
              <button
                className="delete"
                aria-label="close"
                onClick={this.toggleAddress}></button>
            </header>
          ...
          <div className="modal-card">
            <header className="modal-card-head">
              ...
              <button
                className="delete"
                aria-label="close"
                onClick={this.toggleContact}></button>
            </header>
            <section className="modal-card-body">
              <div className="is-hidden-mobile">
                <div className="titles columns">
                  <span
                    className="column has-text-centered is-uppercase has-text-weight-semibold">
                      Office
                  </span>
                  <span
                    className="column has-text-centered is-uppercase has-text-weight-semibold">
                ...
                <div className="columns">
                  <span className="column has-text-centered">(352) 462-0414</span>
                  <span className="column has-text-centered">(888) 413-6642</span>
              ...
              <div className="is-flex-mobile is-hidden-desktop is-hidden-tablet">
                <div className="columns">
                  <span
                    className="column has-text-centered is-uppercase has-text-weight-semibold titles">
                      Office
                  </span>
                  <span className="column has-text-centered">(352) 462-0414</span>
                </div>
